...
let wishlist = [];
    ...
    .then(data => {
        ...
        plusButton.addEventListener('click', () => openModal(product, index));
...
function openModal(product, dataIndex) {
    const productInfoContent = `
        <div class="modal-content">
            <span class="close" onclick="closeModal()">&times;</span>
            <h2>Información Adicional</h2>
            <img src="${product.image_link || '../img/nofoto.jpg'}" alt="${product.name}" class="modal-image">
